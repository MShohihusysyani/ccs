    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url('helpdesk3') ?>">CCS | HELPDESK</a>
            </div>
        ...
        <aside id="leftsidebar" class="sidebar">
                ...
                <div class="info-container">
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            <li><a
                                    href="<?= base_url() ?>user/profile_helpdesk/<?= $this->session->userdata('id'); ?>"><i
                                        class="material-icons">person</i>Profile</a>
                            </li>
                            <li class="<?= $this->uri->segment(2) == 'changepassword2' ? 'active' : ' ' ?>"><a
                                    href="<?= base_url('user/changepassword_helpdesk') ?>"><i
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li
                        class="active">
                        <a href="<?php echo base_url('helpdesk3') ?>">
                    ...
                    <li>
                        ...
                        <a href="<?php echo base_url('helpdesk3/pelaporan') ?>">
                    ...
                    <li>
                        ...
                        <a href="<?php echo base_url('helpdesk3/data_pelaporan') ?>">
                            <i class="material-icons">view_list</i>
