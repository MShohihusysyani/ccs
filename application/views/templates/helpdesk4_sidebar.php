    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url('helpdesk4') ?>">CCS | HELPDESK</a>
            </div>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li
                        class="active">
                        <a href="<?php echo base_url('helpdesk4') ?>">
                    ...
                    <li>
                        ...
                        <a href="<?php echo base_url('helpdesk4/pelaporan') ?>">
                    ...
                    <li>
                        <!-- <?= $this->uri->segment(2) == 'jabatan' || $this->uri->segment(1) == '' ? 'class="active"' : '' ?> -->
                        <a href="<?php echo base_url('helpdesk4/data_pelaporan') ?>">
                            <i class="material-icons">view_list</i>
