...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 03 Apr 2024 pada 10.28
...
(61, 'TIC2024040006', 28, 'Kredit - PPAP Kredit', '2024-04-03', 'Forward To Helpdesk 4', 'HANDLE', 'Medium', '<p>Perbaikan PPAP Kredit</p>', '17020182373761.png', 'PT BPR BKK Karangmalang(Perseroda)', NULL, NULL, NULL),
...
(63, 'TIC2024040008', 28, 'Kredit - Agunan', '2024-04-03', 'proses', 'ADDED', 'Medium', '<p>Perbaikan nilai wajar pada agunan</p>', '17020182373762.png', 'PT BPR BKK Karangmalang(Perseroda)', NULL, NULL, NULL),
(64, 'TIC2024040009', 20, 'Kredit - Transaksi Kredit', '2024-04-03', 'proses', 'ADDED', 'Medium', '<p>Perbaikan PPAP Kredit</p>', 'CCS_Customer_Care_System_(4).xlsx', 'PT BPR BKK Banjarharjo(Perseroda)', NULL, NULL, NULL);
...
--
ALTER TABLE `tiket_temp`
  MODIFY `id_temp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102;
