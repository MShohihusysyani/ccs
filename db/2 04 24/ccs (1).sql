...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 02 Apr 2024 pada 10.44
...
(57, 'TIC2024040002', 28, 'Backdate - Backdate Transaksi', '2024-04-02', 'Forward To Helpdesk 4', 'HANDLE', 'Medium', '<p>Permintaan Backadate</p>', 'CCS_Customer_Care_System.pdf', 'PT BPR BKK Karangmalang(Perseroda)', NULL, NULL, NULL),
(58, 'TIC2024040003', 33, 'Backdate - Backdate Transaksi', '2024-04-02', 'Forward To Helpdesk 4', 'HANDLE', 'Medium', '<p>Permintaan Backdate</p>', 'CCS_Customer_Care_System1.xlsx', 'PT BPR BKK Kab. Pekalongan(Perseroda)', NULL, NULL, NULL),
(59, 'TIC2024040004', 33, 'Kredit - Agunan', '2024-04-02', 'Forward To Helpdesk 4', 'HANDLE', 'Low', '<p>Permintaan perbaikan data agunan</p>', 'ELS-14-Maret-2024.pdf', 'PT BPR BKK Kab. Pekalongan(Perseroda)', NULL, NULL, NULL),
(60, 'TIC2024040005', 33, 'Pembatalan - Pembatalan Transaksi(Current Date, Backdate, Adendum Kredit dan Ecollector)', '2024-04-02', 'Forward To Helpdesk 4', 'HANDLE', 'Low', '<p>Pembatalan transaksi current date</p>', '1702018237376.png', 'PT BPR BKK Kab. Pekalongan(Perseroda)', NULL, NULL, NULL);
...
--
ALTER TABLE `tiket_temp`
  MODIFY `id_temp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=98;
